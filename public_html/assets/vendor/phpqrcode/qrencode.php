 ...
 */
    ...
    class QRrawcode {
        ...
        public function getCode()
        {
            ...
            if($this->count < $this->dataLength) {
                ...
                $col = intdiv($this->count, $this->blocks); // era divisão float (/) usada como índice — descontinuado no PHP 8.1+
                ...
                $col = intdiv($this->count - $this->dataLength, $this->blocks); // idem acima
    ...
    class QRencode {
        ...
        public $cmyk = false; // declarado explicitamente (era propriedade dinâmica, descontinuado no PHP 8.2+)
